 ...
 * @param {boolean} debugOptions - Flag to enable/disable debug options.
*/
module.exports = function calloutConverter(folderPath, errorLogPath, debugOptions) {
  ...
  files.forEach(file => {
    ...
    if (matchResults.length > 0) {
      ...
      console.log(`Replacement performed in: ${file}`);
    } else {
