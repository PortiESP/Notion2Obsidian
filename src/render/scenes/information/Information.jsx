...
export default function Information(){
    ...
    return (<div className={sass.div__information_wrap}>
            ...
            <div className={sass.div__info_wrap}>
                <div className={sass.div__item}><span>🧪</span><p> This is a <b className={sass.b}>beta</b> version of the project, visit the <a className={sass.a} onClick={()=>postOffice("open-url", "https://github.com/PortiESP/Notion2Obsidian")}>Github</a> page to stay updated</p></div>
                <div className={sass.div__item}><span>🕷️</span><p> Please <b className={sass.b}>report</b> any issues or bugs in the <a className={sass.a} onClick={()=>postOffice("open-url", "https://github.com/PortiESP/Notion2Obsidian/issues")}>issues</a> section of the github page</p></div>
