...
export default function ResultsPage({results}){
    ...
    return (<div className={sass.div__results_wrap}>
        ...
        <div>
            ...
            <hr/>
            <p className={sass.p__msg}>· Missing databases <span>({results?.findMissingDBs ? results.findMissingDBs?.length : 0})</span></p>
            <p className={sass.p__msg}>· Files with asterisks <span>({results?.stripAsterisks ? results.stripAsterisks?.length : 0})</span></p>
            <hr/>
